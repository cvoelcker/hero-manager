"""
Django settings for heromanager project.
...
SECRET_KEY = 'av%z-cgml8bj7xdw9!o#ae)nt=%*lz057ub6!hiogp56ynwa)j'
...
WSGI_APPLICATION = 'heromanager.wsgi.application'
